### Network Description File ### Conf-4
...
st_2 = terminal(pytsn,id=2,lan_id=1,dest_id=5,flow_id= 1,priority=1,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=25e-6,rate=1000,debug=True)
...
# our method
cmn_gcl_ts_list = [[50e-6],[950e-6]] # for CT = 10e-3
cmn_gcl_list = [[1],[-1]]
