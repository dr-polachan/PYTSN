...
# TCPS terminals
hTCPS1 = tcps(pytsn,id=1,dest_id=2,priority=0,start_time=0,stop_time=float("inf"),\
        rate=1000,debug=True,pkt_size=100,burst_count=1)

hTCPS2 = tcps(pytsn,id=2,dest_id=1,priority=0,start_time=0,stop_time=float("inf"),\
        rate=1000,debug=True,pkt_size=100,burst_count=1)
