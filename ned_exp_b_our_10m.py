...
# 1 <-> 4
st_1 = terminal(pytsn,id=1,lan_id=1,dest_id=4,flow_id= -1,priority=0,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=0,rate=1000,debug=True)

st_4 = terminal(pytsn,id=4,lan_id=1,dest_id=1,flow_id= -1,priority=0,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=0,rate=1000,debug=True)

# 2 <-> 5

st_2 = terminal(pytsn,id=2,lan_id=1,dest_id=5,flow_id= 1,priority=0,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=15e-6,rate=1000,debug=True)
...
st_3 = terminal(pytsn,id=3,lan_id=1,dest_id=6,flow_id= 2,priority=0,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=30e-6,rate=1000,debug=True)

st_6 = terminal(pytsn,id=6,lan_id=1,dest_id=3,flow_id= 2,priority=0,\
	adist=dist_st.adist,sdist=dist_st.sdist,initial_delay=30e-6,rate=1000,debug=True)

# switches 

# st/be ratio method
#cmn_gcl_ts_list = [[2.9e-6],[2.4e-6],[9994.7e-6]] # for CT = 10e-3
##cmn_gcl_ts_list = [[2.9e-6],[2.4e-6],[994.7e-6]] # for CT = 1e-3
##cmn_gcl_ts_list = [[2.9e-6],[2.4e-6],[44.7e-6]] # for CT=50us
#cmn_gcl_list = [[-1],[2],[-1]]

# our method
cmn_gcl_ts_list = [[15e-6],[15e-6],[15e-6],[9955e-6]] # for CT = 10e-3
##cmn_gcl_ts_list = [[2.9e-6],[2.4e-6],[994.7e-6]] # for CT = 1e-3
##cmn_gcl_ts_list = [[2.9e-6],[2.4e-6],[44.7e-6]] # for CT=50us
cmn_gcl_list = [[-1],[1],[2],[0]]
