### Network Description File ### Conf-2
...
# our method
cmn_gcl_ts_list = [[1e-3]] # for CT = 1e-3
cmn_gcl_list = [[1,-1]]
...
sw_0 = switch_ss(pytsn,sw_0_fwd_tbl,qlimit=1000, \
...
sw_1 = switch_ss(pytsn,sw_1_fwd_tbl,qlimit=1000, \
	gcl_ts_list=cmn_gcl_ts_list, gcl_list=cmn_gcl_list, rate=1000, pro_delay=0.5e-6)
